                                ...
                                <table class="table table-sm mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="align-middle" style={{ minWidth: "12.5rem" }}>
                                                Ship To
                                            </th>
                                    ...
                                    <tbody id="orders">
                                        <tr class="btn-reveal-trigger">
                                            ...
                                            <td class="py-2 text-end">
                                                <span class="badge badge-success">
                                                    Completed<span class="ms-1 fa fa-check"></span>
                                                </span>
                                            </td>
                                        ...
                                        <tr class="btn-reveal-trigger">
                                            ...
                                            <td class="py-2 text-end">
                                                <span class="badge badge-primary">
                                                    Processing<span class="ms-1 fa fa-redo"></span>
                                                </span>
                                            </td>
                                            <td class="py-2 text-end">$120</td>
                                            <td class="py-2 text-end">
                                                <div class="dropdown text-sans-serif">
                                                    <button
                                                        class="btn btn-primary tp-btn-light sharp"
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="order-dropdown-1">
                                                        <div class="py-2">
                                                            <a class="dropdown-item" href="javascript:void(0);">
                                                                Completed
                                                            </a>
                                        ...
                                        <tr class="btn-reveal-trigger">
                                            ...
                                            <td class="py-2 text-end">
                                                <span class="badge badge-secondary text-white">
                                                    On Hold<span class="ms-1 fa fa-ban"></span>
                                                </span>
                                            </td>
                                            <td class="py-2 text-end">$70</td>
                                            <td class="py-2 text-end">
                                                <div class="dropdown text-sans-serif">
                                                    <button
                                                        class="btn btn-primary tp-btn-light sharp"
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="order-dropdown-2">
                                                        <div class="py-2">
                                                            <a class="dropdown-item" href="javascript:void(0);">
                                                                Completed
                                                            </a>
                                        ...
                                        <tr class="btn-reveal-trigger">
                                            ...
                                            <td class="py-2 text-end">
                                                <span class="badge badge-warning">
                                                    Pending<span class="ms-1 fas fa-stream"></span>
                                                </span>
                                            </td>
                                            <td class="py-2 text-end">$92</td>
                                            <td class="py-2 text-end">
                                                <div class="dropdown text-sans-serif">
                                                    <button
                                                        class="btn btn-primary tp-btn-light sharp"
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="order-dropdown-3">
                                                        <div class="py-2">
                                                            <a class="dropdown-item" href="javascript:void(0);">
                                                                Completed
                                                            </a>
                                        ...
                                        <tr class="btn-reveal-trigger">
                                            ...
                                            <td class="py-2 text-end">
                                                <div class="dropdown text-sans-serif">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="order-dropdown-4">
                                                        <div class="py-2">
                                                            <a class="dropdown-item" href="javascript:void(0);">
                                                                Completed
                                                            </a>
                                        ...
                                        <tr class="btn-reveal-trigger">
                                            ...
                                            <td class="py-2 text-end">
                                                <div class="dropdown text-sans-serif">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="order-dropdown-5">
                                                        <div class="py-2">
                                                            <a class="dropdown-item" href="javascript:void(0);">
                                                                Completed
                                                            </a>
                                        ...
                                        <tr class="btn-reveal-trigger">
                                            ...
                                            <td class="py-2 text-end">
                                                <div class="dropdown text-sans-serif">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="order-dropdown-6">
                                                        <div class="py-2">
                                                            <a class="dropdown-item" href="javascript:void(0);">
                                                                Completed
                                                            </a>
                                        ...
                                        <tr class="btn-reveal-trigger">
                                            ...
                                            <td class="py-2 text-end">
                                                <div class="dropdown text-sans-serif">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="order-dropdown-7">
                                                        <div class="py-2">
                                                            <a class="dropdown-item" href="javascript:void(0);">
                                                                Completed
                                                            </a>
                                        ...
                                        <tr class="btn-reveal-trigger">
                                            ...
                                            <td class="py-2 text-end">
                                                <div class="dropdown text-sans-serif">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="order-dropdown-8">
                                                        <div class="py-2">
                                                            <a class="dropdown-item" href="javascript:void(0);">
                                                                Completed
                                                            </a>
                                        ...
                                        <tr class="btn-reveal-trigger">
                                            ...
                                            <td class="py-2 text-end">
                                                <div class="dropdown text-sans-serif">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="order-dropdown-9">
                                                        <div class="py-2">
                                                            <a class="dropdown-item" href="javascript:void(0);">
                                                                Completed
                                                            </a>
                                        ...
                                        <tr class="btn-reveal-trigger">
                                            ...
                                            <td class="py-2 text-end">$69</td>
                                            <td class="py-2 text-end">
                                                <div class="dropdown text-sans-serif">
                                                    <button
                                                        class="btn btn-primary tp-btn-light sharp"
                                                        type="button"
                                                        id="order-dropdown-10"
                                                        data-bs-toggle="dropdown"
                                                        data-boundary="viewport"
                                                        aria-haspopup="true"
                                                        aria-expanded="false"
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="order-dropdown-10">
                                                        <div class="py-2">
                                                            <a class="dropdown-item" href="javascript:void(0);">
                                                                Completed
                                                            </a>
                                        ...
                                        <tr class="btn-reveal-trigger">
                                            ...
                                            <td class="py-2 text-end">$112</td>
                                            <td class="py-2 text-end">
                                                <div class="dropdown text-sans-serif">
                                                    <button
                                                        class="btn btn-primary tp-btn-light sharp"
                                                        type="button"
                                                        id="order-dropdown-11"
                                                        data-bs-toggle="dropdown"
                                                        data-boundary="viewport"
                                                        aria-haspopup="true"
                                                        aria-expanded="false"
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="order-dropdown-11">
                                                        <div class="py-2">
                                                            <a class="dropdown-item" href="javascript:void(0);">
                                                                Completed
                                                            </a>
