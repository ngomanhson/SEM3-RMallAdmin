...
function FoodCounterCreate() {
    return (
        <>
            <Helmet>
                <title>Food Counter Create | R Mall</title>
            </Helmet>
            <Layout>
                    ...
                    <div className="col-xl-12 col-xxl-12">
                        <div className="card">
                            <div className="card-header">
                                <h4 className="card-title">Food Counter Create</h4>
                            </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-6 mb-2">
                                            <div className="mb-3">
                                                ...
                                                <textarea className="form-control" placeholder="Description of the food counter"></textarea>
                                            </div>
                                        </div>
...
export default FoodCounterCreate;
