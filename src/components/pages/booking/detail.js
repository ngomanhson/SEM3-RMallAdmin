...
function BookingDetail() {
    ...
    const loadBooking = useCallback(async () => {
        ...
        try {
            const bookingResponse = await api.get(url.BOOKING.DETAIL + `/${bookingCode}`, config);
                ...
                {error ? (
                    <div className="card">
                        <div className="card-body">
                            <h2>No booking history found. Please check again!</h2>
                                        ...
                                        <table className="table table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td className="right text-white">{bookingDetail && bookingDetail.startDate && format(new Date(bookingDetail.startDate), "HH:mm:ss dd/MM/yyyy")}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                                ...
                                                <div className="ticket">
                                                    ...
                                                    <div className="body-ticket">
                                                        ...
                                                        <div className="produits">
                                                            ...
                                                            <div className="col2">
                                                                <p>Start Date</p>
                                                                <p className="prix">{bookingDetail && bookingDetail.startDate && format(new Date(bookingDetail.startDate), "HH:mm:ss dd/MM/yyyy")}</p>
                                                            </div>
                                                            <div className="hr-lg"></div>
                                                            <div className="col2">
                                                                <p>Seat code</p>
