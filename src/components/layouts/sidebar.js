            ...
            <div className="dlabnav-scroll">
                <ul className="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li>
                                <Link to="/booth-list">Booth List</Link>
                            </li>
                            <li>
                                <Link to="/booth-create">Booth Create</Link>
                            </li>
                            <li>
                                <Link to="/booth-edit">Booth Edit</Link>
                            </li>
                            <li>
                                <Link to="/booth-delete-at">Booth Delete At</Link>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li>
                                <Link to="/food-counter-list">Food Counter List</Link>
                            </li>
                            <li>
                                <Link to="/food-counter-create">Food Counter Create</Link>
                            </li>
                            <li>
                                <Link to="/food-counter-edit">Food Counter Edit</Link>
                            </li>
                            <li>
                                <Link to="/food-counter-delete-at">Food Counter Delete At</Link>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li>
                                <Link to="/movie-create">Movie Create</Link>
                            </li>
                            <li>
                                <Link to="/movie-edit">Movie Edit</Link>
                            </li>
                            <li>
                                <Link to="/movie-delete-at">Movie Delete At</Link>
                            </li>
                        </ul>
                    </li>

                    <li>
                        <NavLink className="has-arrow " to="/show-times" aria-expanded="false">
                            <div className="menu-icon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g id="IconlyDocument">
                                        <g id="Document">
                            ...
                            <span className="nav-text">Show times</span>
                        </NavLink>
                    </li>
